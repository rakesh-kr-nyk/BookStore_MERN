...
function Banner() {
  return (
      ...
      <div className='max-w-screen-2x1 container mx-auto md:px-20 px-4 flex flex-col-reverse md:flex-row '>
              <div className='md:w-1/2 mt-12 md:mt-32'>
                  ...
                  <h1 className='text-4xl font-bold'>Hello & Welcome! Join us to learn something <span className='text-[#62beff]'>new every day.</span></h1>
  ...
  <button className="button self-start">Join Now</button>
</div>
                  </div>
